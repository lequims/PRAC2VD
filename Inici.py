...
st.set_page_config(page_title='PRA2 VISUALITZACIÓ DE DADES', layout='wide')
st.title('Pràctica 2 de Visualització de dades')

st.markdown("""
En aquesta pràctica s'han combinat tres dataset publicats al Cataleg obert de dades de la 
